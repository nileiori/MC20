...
#define     MSG_ID_EV_USER_FUNCTION (MSG_ID_USER_START + 3)
#define     MSG_ID_TIME_USER_FUNCTION     (MSG_ID_USER_START + 4)

#define     MSG_ID_BLIND_SAVE      (MSG_ID_USER_START + 7)
#define     MSG_ID_BLIND_CALLBACK  (MSG_ID_USER_START + 8)
#define     MSG_ID_GNSS_CTR         (MSG_ID_USER_START + 9)
