...
#define TCP_TIMER_ID         TIMER_ID_USER_START	//tcp链接定时器
#define TIMEOUT_90S_TIMER_ID TIMER_ID_USER_START + 1   //timeout

#define TIME_TASKSCHEDULE_ID  	 	(TIMER_ID_USER_START + 2)				//系统任务调到定时器
#define LOGIC_BLIND_SAVE_TMR_ID  	(TIMER_ID_USER_START + 3)	
#define LOGIC_WTD_TMR_ID  			(TIMER_ID_USER_START + 4)
#define TIME_REPORT_TIME_ID  	 	(TIMER_ID_USER_START + 5)			//定时上报任务
#define LOGIC_BLIND_REPORT_TMR_ID  	(TIMER_ID_USER_START + 6)	
#define TIME_GPS_ID  	 			(TIMER_ID_USER_START + 7)				//GPS定位
#define TIMEOUT_TIME_GPS_ID 		(TIMER_ID_USER_START + 8)				//GPS,WIFI定位超时
