...
TASK_ITEM(proc_report_task, report_task_id, 5*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
TASK_ITEM(proc_blind_task, blind_task_id,	5*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
TASK_ITEM(proc_sysCtrl_task,sysCtrl_task_id,10*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
TASK_ITEM(proc_ledctr_task, ledctr_task_id, 5*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
//TASK_ITEM(proc_softWdg_task, softWdg_task_id, 5*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
#endif
